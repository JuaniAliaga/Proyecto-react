    ...
    return (
        <div className="container-fluid d-flex justify-content-center">
            <div className="card mt-4" style={{ maxWidth: "550px", maxHeight: "550px" }}>
                ...
                <h1 className="card-title text-center mt-1">{item.nombre}</h1>
                <span className="card-text text-start ms-3 mt-1 mb-1 fw-bold">${item.precio}</span>
                <p className="card-text text-center fw-bold mt-2 mb-2">{item.descripcion}</p>
